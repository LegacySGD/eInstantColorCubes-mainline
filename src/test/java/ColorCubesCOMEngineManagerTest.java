...
public class ColorCubesCOMEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(ColorCubesCOMEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/ColorCubesIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/ColorCubesIW/InitOutcome.xml").getDocumentElement();
